...
| 紧凑常用工具栏 | 左侧小型新建/打开/保存与撤销/重做；段落样式、粗体/强调、基础数学入口；源码模式显示语言和草稿操作 |
| 文档标签与工作方式 | 当前文档标签；切换所见即所得/源码；不使用额外的“笔记/导出/恢复”场景导航占用工作区 |
| 模式与焦点上下文 | 紧凑显示文本/数学与当前位置；高级 capability 焦点操作按阶段 2 扩展，不再常驻一整列属性卡片 |
...
桌面草图的尺寸建议：标题约 25、菜单约 29、工具栏约 33、标签行约 30、上下文约 25、状态栏约 25 逻辑像素。
