...
> **有效性（2026-09-17 登记）**：自研最小基线的原始证据，**不用于关闭引擎选型**（其关联 ADR 已如此声明）；引擎选型由 [ADR 0009](../adr/ADR-0009-crdt-engine.md) 依 [报告 0014](SPK-0014-crdt-engines.md) 固定。阶段 0 当前判定见 [报告 0012](SPK-0012-exit-criteria.md)。
...
1. **第三方 CRDT 引擎没有比较。** 本 spike 按要求自研实现，没有引入 Loro / Yrs / Automerge，
   ...
   [报告 0013](SPK-0013-crdt-prescreen.md) 预筛，选型判据见 [ADR 0009](../adr/ADR-0009-crdt-engine.md)
