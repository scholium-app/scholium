...
| # | 出口条件 | 判定 | 证据与剩余边界 |
|---|---|---|---|
| 1 | 原生候选共同验收、锁定版本与平台 | **部分满足** | [0021](SPK-0021-native-edit-acceptance.md) 已复测真实 IME、数学编辑、双源码草稿、拖选/剪切/撤销、滚动和 AT-SPI；[0022](SPK-0022-slot-selection.md) 补槽位选区与整节点替换；新增路径的真实窗口、结构反馈、大源码、完整无障碍及团队/预览定位/文件恢复集成仍未闭合 |
...
2. 完成条件 3 的实际呈现性能验证，分别定义 UI 帧预算和预览刷新预算。
